...
using Minion.Inject;
using Minion.Inject.Tests.AssortedTestClasses;
using Minion.Inject.Profiling;
using Microsoft.Extensions.DependencyInjection;

namespace Minion.Tests.InjectTests.Integration
{
    public class ContainerIntegrationTests
    {
        private Container getContainer()
        {
            ...
            var container = new Container(profiler);
        ...
        public void container_add_registration_transient1()
        {
            ...
            var actual = container.GetService(typeof(IClockEvent));
        ...
        public void container_add_registration_singleton()
        {
            ...
            container.AddSingleton<IClockEvent, ClockEvent>();
        ...
        public void container_add_singleton_registration_with_object1()
        {
            ...
            container.AddSingleton<IClockEvent, ClockEvent>(instance: target);
        ...
        {
            var container = getContainer();
            container.AddScoped<IClockEvent, ClockEvent>();
        ...
        public async void container_add_two_threads_async()
        {
            ...
            var actual1 = container.GetScoped<IClockEvent>();
            var actual2 = container.GetScoped<IClockEvent>();
